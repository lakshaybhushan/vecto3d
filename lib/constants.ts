...
export const TEXTURE_PRESETS: TexturePreset[] = [
  ...
  },
  {
    ...
    label: "Oak Veneer",
    category: "wood",
    diffuseMap: `${TEXTURE_BASE_URL}/wood/oak_veneer_diffuse.jpg`,
    normalMap: `${TEXTURE_BASE_URL}/wood/oak_veneer_normal.jpg`,
    roughnessMap: `${TEXTURE_BASE_URL}/wood/oak_veneer_roughness.jpg`,
    aoMap: `${TEXTURE_BASE_URL}/wood/oak_veneer_ao.jpg`,
    previewImage: `${TEXTURE_BASE_URL}/wood/previews/oak_veneer_preview.jpg`,
    repeat: { x: 2, y: 2 },
    roughnessAdjust: 1.0,
    metalnessAdjust: 0.0,
    bumpScale: 0.02,
  ...
  },
  {
    ...
    category: "stone",
    diffuseMap: `${TEXTURE_BASE_URL}/stone/concrete_diffuse.jpg`,
    normalMap: `${TEXTURE_BASE_URL}/stone/concrete_normal.jpg`,
    roughnessMap: `${TEXTURE_BASE_URL}/stone/concrete_roughness.jpg`,
    previewImage: `${TEXTURE_BASE_URL}/stone/previews/concrete_preview.jpg`,
    repeat: { x: 3, y: 3 },
    roughnessAdjust: 1.0,
    metalnessAdjust: 0.0,
    bumpScale: 0.015,
  },
  {
    ...
    label: "Rocky Terrain",
    category: "stone",
    diffuseMap: `${TEXTURE_BASE_URL}/stone/rock_diffuse.jpg`,
    normalMap: `${TEXTURE_BASE_URL}/stone/rock_normal.jpg`,
    roughnessMap: `${TEXTURE_BASE_URL}/stone/rock_roughness.jpg`,
    previewImage: `${TEXTURE_BASE_URL}/stone/previews/rock_preview.jpg`,
    repeat: { x: 2, y: 2 },
    roughnessAdjust: 1.0,
    metalnessAdjust: 0.0,
    bumpScale: 0.01,
  ...
  },
  {
    ...
    label: "Asphalt",
    category: "miscellaneous",
    diffuseMap: `${TEXTURE_BASE_URL}/road/asphalt_diffuse.jpg`,
    normalMap: `${TEXTURE_BASE_URL}/road/asphalt_normal.jpg`,
    roughnessMap: `${TEXTURE_BASE_URL}/road/asphalt_roughness.jpg`,
    aoMap: `${TEXTURE_BASE_URL}/road/asphalt_ao.jpg`,
    previewImage: `${TEXTURE_BASE_URL}/road/previews/asphalt_preview.jpg`,
    repeat: { x: 5, y: 5 },
    roughnessAdjust: 1.0,
    metalnessAdjust: 0.0,
    bumpScale: 0.01,
  },
  {
    ...
    label: "Snow",
    category: "miscellaneous",
    diffuseMap: `${TEXTURE_BASE_URL}/weather/snow_diffuse.jpg`,
    normalMap: `${TEXTURE_BASE_URL}/weather/snow_normal.jpg`,
    roughnessMap: `${TEXTURE_BASE_URL}/weather/snow_roughness.jpg`,
    previewImage: `${TEXTURE_BASE_URL}/weather/previews/snow_preview.jpg`,
    repeat: { x: 6, y: 6 },
    roughnessAdjust: 1.0,
    metalnessAdjust: 0.0,
    bumpScale: 0.005,
